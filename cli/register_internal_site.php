...
//
// This CLI exists so provisioning can register the box. `status => 'ok'` means
...
//
// 'unchanged' is a success: the local record already matched the requested UUID
// and site URL, so there was nothing to send.
