...
/**
 * The update_request event class.
 * This event is triggered when Moodiy request to latest updates from the site.
 *
 ...
 */
class update_request extends \core\event\base {
    /**
     * Init method.
     *
     * @return void
    ...
    public static function get_name() {
        return get_string('updaterequest', 'tool_moodiyregistration');
    }
